...
export default function UpdateModel({ SelectCard, EditModal, setEditModal, UpdateMOdel, UpdateContact }) {
    const addbtnClose = () => {

        setEditModal(false)
    }
    const [Name, setName] = useState(SelectCard == "" ?  SelectCard.Name : '' );
    const [Email, setEmail] = useState(SelectCard == "" ?  SelectCard.Email : '' );
    // }
    // const [Name, setName] = useState(SelectCard == "" ? '' : SelectCard.Name);
    // const [Email, setEmail] = useState(SelectCard == "" ? '' : SelectCard.Email);
    const Submit = () => {
                    ...
                    >
                        ...
                        >
                            ...
                            <ModelBody>
                                ...
                                <NAmeINput placeholder="Enter Your Name" type='text' value={Name} onChange={(e) => setName(e.target.value)} />
                            ...
                            <div className="d-flex justify-content-evenly mt-4 pt-4 position-relative top-25">
                                <BUtton onClick={addbtnClose}>close</BUtton>
                                {
                                    (SelectCard == "") ?
                                        < BUtton onClick={Submit} >Add Contact </BUtton>
                                        :
                                        <BUtton onClick={Submit} >Update Contact </BUtton>
                                }
                            </div>
                        </ModelMain>
                    </BlackLayer>
